...
def reformat_tournament(driver, file_path, id_to_name, all_matches, all_matches_publish, headers, params):
...
def process_matches():
  ...
  for index, row in df_tournaments.iterrows():
    ...
    reformat_tournament(driver, tournament_path, id_to_name, all_matches, all_matches_publish, headers, params)
